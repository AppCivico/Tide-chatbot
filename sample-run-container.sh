...
export SOURCE_DIR='/home/lucas-eokoe/projects/tide-chatbot'
export DATA_DIR='/tmp/tide-chatbot/data/'
...
docker run --name mandatoaberto-chatbot \
 ...
 -p $DOCKER_LAN_IP:$LISTEN_PORT:1238 \
 --cpu-shares=512 \
 --memory 1800m -dit --restart unless-stopped appcivico/tide-chatbot
